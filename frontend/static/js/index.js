...
function render_boost(parent, boost){
  ...
  <div class=${class_boost} id="boost-holder">
    <input id="buy" type="image" class="coin boost" src="https://operkor.files.wordpress.com/2019/02/d092d0a0-d09ad090d091d09cd098d09dd091d0aed094d096d095d0a2-d0a2d090d09dd0a6d0ab.jpg?w=2048&h=1490" onclick="buyBoost(${boost.level})" />
